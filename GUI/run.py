...
class QImageViewer(QMainWindow):
    ...
    def criarTableView(self):
        ...
        self.tableView.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.label.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.coletarAmostra.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.relatorioAnalise.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.radioAmonia.setStyleSheet("background-image: url(transparent.png)")   
        ...
        self.radioNitrato.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.radioNitrito.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.avaliar.setStyleSheet("background-image: url(transparent.png)")

        self.groupBox = QtWidgets.QGroupBox(self)
        self.groupBox.setGeometry(QtCore.QRect(550, 370, 231, 80))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.groupBox.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.visualizarRelatorio.setStyleSheet("background-image: url(transparent.png)")
        ...
        self.enviarSMS.setStyleSheet("background-image: url(transparent.png)")

        self.pushButton = QtWidgets.QPushButton(self.groupBox)
        self.pushButton.setGeometry(QtCore.QRect(70, 50, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.setText("OK")        
        self.pushButton.setStyleSheet("background-image: url(transparent.png)")                        
    ...
    def createMenus(self):
        ...
        self.fileMenu.setStyleSheet("background-image: url(transparent.png)")
